...
namespace eshopv2.reportTemplates.product
{
    public partial class productPrint : System.Web.UI.Page
    {
        ...
        private string loadTemplate(string type)
        {
            ...
            using (TextReader tr = new StreamReader(Server.MapPath("~/reportTemplates/" + template)))
            {
                return tr.ReadToEnd();
            }
        }
        ...
        private Dictionary<string, string> getReplaceTags(Product product)
        {
            ...
            replaceTags.Add("CSS-PATH", Server.MapPath("~/reportTemplates/report-style.css"));
        ...
        private Dictionary<string, string> getHeaderTags()
        {
            ...
            tags.Add("CSS-PATH", Server.MapPath("~/reportTemplates/report-style.css"));
